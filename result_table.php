  ...
  <section id="container">
    ...
    <!--  <div class="top-menu">
        <ul class="nav pull-right top-menu">
          <li><a class="logout" data-toggle="modal" href="result_table.php#myModal">Logout</a></li>
        </ul>
      </div>-->
    </header>
    <!--header end-->
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Quiz & Assesment</h3>
        <div class="row mb">
          <!-- page start-->
            ...
            <div class="adv-table">
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                <thead>
                  <tr>
                    <th>Date</th>
                    <th>Quiz / Assesment</th>
                    <th class="hidden-phone">Subject Name</th>
                    <th>Marks %</th>
                    <th class="hidden-phone">Grades</th>
                  </tr>
                </thead>
                <tbody>
                  <tr class="gradeA">
                    <td>2020/12/02</td>
                    <td>DATABASE MANUPIRATIOM</td>
                    <td class="hidden-phone">SAD</td>
                    <td>25 / 30</td>
                    <td class="center hidden-phone">B</td>
                  </tr>
                </tbody>
              </table>
            </div>
