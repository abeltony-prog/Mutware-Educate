...
include('include/logout.php') ?>
  <head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <title>Mutware - Add Departments</title>
    <!-- plugins:css -->
          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Add Department / Class</h4>
                      <form class="forms-sample" action="" method="post">
                      <div class="row col-md-12">
                        <div class="form-group col-md-12">
                          <label for="exampleInputEmail3">Department Name</label>
                          <input type="text" name="name" class="form-control" id="exampleInputEmail3" placeholder="S3/P6/L4 Department Name">
                        </div>
                      </div>
                      <input class="btn mr-2" style="background-color:#4ECDC4;"  type="text" name="add" value=" Add Department">
                    ...
                    <?php
                     if (isset($_POST['add'])) {
                       ...
                       DB::query('INSERT INTO department VALUES(\'\',:schl_id,:name)', array(
                         ':schl_id'=>$schl_id,':name'=>$name
                       ));
                       echo "Department Add";
                          ...
                          <?php
                            ...
                            foreach ($all as $k) {
                              ...
                              <tr>
                                ...
                                <?php
                                  $allhead = DB::query('SELECT * FROM teachers WHERE department_id=:depid', array(':depid'=>$k['id']));
                                  foreach ($allhead as $all) {
                                    if ($all['role'] == "Head of class") {
                                    ?>
                                    <td>
                                      <?php echo $all['name']; ?>
                                    </td>
