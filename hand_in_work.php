  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        <h3><i class="fa fa-folder-open"></i> Class Work</h3>
        <div class="row mt">
          <div class="col-lg-12">
                ...
                <div class="col-lg-12">
                  <table style="width:100%">
                    ...
                    foreach ($result as $key) {
                      ...
                      <tr>
                        <td><a class="fa fa-file-pdf-o" style="text-decoration:none" href="view.php?work=view&id=<?php echo $key['id'] ?>"> <?php echo $key['file']; ?></a></td>
                        <td style="color:red"><?php echo $key['deadline']; ?></td>
                        <?php
                          $sub = DB::query('SELECT subject FROM subjects WHERE id=:key', array(':key'=>$key['sub_id']));
