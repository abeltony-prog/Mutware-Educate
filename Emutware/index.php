...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="index.php" class="logo"><b>M<span>utware</span></b></a>
      <!--logo end-->
            ...
            <ul class="dropdown-menu extended inbox">
              ...
              <li>
                <a href="index.php#">
                  ...
                  <span class="subject">
                  <span class="from">Software specialist</span>
      ...
      <div class="top-menu">
        <ul class="nav pull-right top-menu">
          <li><a class="logout" href="../web/home.php">Logout</a></li>
        </ul>
      </div>
    </header>
    <!--header end-->
