  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        <?php
        $result = DB::query('SELECT * FROM handed_in WHERE id=:id',array(':id'=>$_GET['id']));
        foreach ($result as $key) {
          ?>
        <h3><i class="fa fa-file-pdf-o "></i> <?php echo $key['file']; ?></h3>
        <form class="" action="" method="post">
          <input type="submit" name="delete" value="Delete">
        </form>
        <?php
          if (isset($_POST['delete'])) {
            DB::query('DELETE FROM handed_in WHERE id=:id', array(':id'=>$key['id']));
            echo "<script>window.open('hand_in_work.php', '_self')</script>";
          }
         ?>
        <div class="row mt">
          <div class="col-lg-12">
                    <object width="100%" height="500px" data="files/docs/return/<?php echo $key['file']; ?>"></object>
              <noscript>
