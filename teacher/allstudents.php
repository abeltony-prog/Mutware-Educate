...
<head>
  <meta charset="utf-8">
  <title>Mutware - All students</title>
          ...
          <div class="col-md-12">
            <section class="task-panel tasks-widget">
              <div class="panel-heading">
                <div class="pull-left">
                <?php
                  $dep = DB::query('SELECT name FROM department WHERE id=:dep_id', array(':dep_id'=>$t['department_id']));
                  foreach ($dep as $key) {
                    ?>
                    <h5><i class="fa fa-tag"></i> <?php echo $key['name']; ?></h5>
                    <?php
                  }
                 ?>
                </div>
              ...
              <div class="panel-body">
                <div class="task-content">
                  ...
                  <?php
                    $student = DB::query('SELECT * FROM students WHERE dep_id=:dep_id',array(':dep_id'=>$t['department_id']));
