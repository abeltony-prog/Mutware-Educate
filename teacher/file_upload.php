          ...
          <div class="col-lg-12">
            ...
            <?php
              if (isset($_POST['upload'])) {
                ...
                DB::query('INSERT INTO notes VALUES(\'\',:sub_id,:schl_id,:dep_id,:file)', array(
                  ':sub_id'=>$sub_id,':schl_id'=>$schl_id,':dep_id'=>$dep_id,':file'=>$file
                ));
              ...
              <div class="col-md-12">
                <section class="task-panel tasks-widget">
                  <div class="panel-heading">
                    <div class="pull-left">
                      <h5><i class="fa fa-folder"></i> Class Notes</h5>
                    </div>
                    <br>
                  </div>
                  <div class="content-panel">
                    <div class="adv-table">
                      <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                        ...
                        <tbody>
                          <?php
                          $result = DB::query('SELECT * FROM notes WHERE dep_id=:dep_id',array(':dep_id'=>$t['department_id']));
                          ...
                          <tr class="gradeX">
                            ...
                            <td>
                              <div class="pull-right">
                                <a href="notesview.php?View=notes&file=<?php echo $key['file'] ?>">
                                  <button class="btn btn-theme btn-xs"><i class=" fa fa-eye"></i></button>
                                </a>
