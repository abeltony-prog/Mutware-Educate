        ...
        *********************************************************************************************************************************************************** -->
        ...
        <section id="main-content">
          <section class="wrapper site-min-height">
            <?php
            $result = DB::query('SELECT * FROM notes WHERE file=:file',array(':file'=>$_GET['file']));
            foreach ($result as $key) {
              ?>
              <h3><i class="fa fa-file-pdf-o "></i> <?php echo $key['file']; ?> / <a href="file_upload.php"><span>Go Back</span> </a> </h3>
            <div class="row mt">
              <div class="col-lg-12">
                  <object width="100%" height="600px" data="../files/docs/work/<?php echo $key['file']; ?>"></object>
              </div>
            </div>
          </section>
<?php   } ?>
