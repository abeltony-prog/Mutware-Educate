          ...
          <div class="col-lg-12">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="form-group col-md-4">
                    <label for="subject">Classes / Department</label>
                    <select class="form-control" name="department">
                      <option value="">Select Class</option>
                      <?php
                      $win = DB::query('SELECT * FROM department WHERE schl_id=:schlid',array(':schlid'=>$t['schl_id']));
                  ...
                  <div class="form-group col-md-4">
                      ...
                      <select class="form-control" name="subject">
                        ...
                        <?php
                        $win = DB::query('SELECT * FROM subjects WHERE schl_id=:schlid',array(':schlid'=>$t['schl_id']));
                          foreach ($win as $value) {
                            ?>
                      ...
                      <div class="row fileupload-buttonbar">
                        <div class="col-lg-8">
                          <!-- The fileinput-button span is used to style the file input field as button -->
                            <button class="btn btn-theme" type="submit" name="search"><i class="fa fa-search"></i>Search</button>
                        </div>
                  </div>
              </div>
            ...
            <?php
              if (isset($_POST['search'])) {
                ...
                $dep_id = DB::query('SELECT id FROM department WHERE name=:name', array(':name'=>$department))[0]['id'];
                $subject = $_POST['subject'];
                $sub_id = DB::query('SELECT id FROM subjects WHERE subject=:subject', array(':subject'=>$subject))[0]['id'];
                $teacher_id = $t['id'];
                DB::query('INSERT INTO classgrp VALUES(\'\',:dep_id,:sub_id,:teacher_id)', array(
                  ':dep_id'=>$dep_id,':sub_id'=>$sub_id,':teacher_id'=>$teacher_id
                ));
              ...
              <div class="col-md-12">
                <section class="task-panel tasks-widget">
                  <div class="panel-heading">
                    <div class="pull-left">
                      <h5><i class="fa fa-folder"></i> My group Links</h5>
                    </div>
                    <br>
                  </div>
                  <div class="content-panel">
                    <div class="adv-table">
                      <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                        ...
                        <tbody>
                        <?php
                        $result = DB::query('SELECT * FROM classgrp WHERE teacher_id=:teacher_id',array(':teacher_id'=>$t['id']));
                        foreach ($result as $key) {
                          ?>
                          <tr class="gradeX">
                            <?php
                            $re = DB::query('SELECT * FROM department WHERE id=:dep_id',array(':dep_id'=>$key['dep_id']));
                            foreach ($re as $value): ?>
                            ...
                            <td>
                              <div class="pull-right">
                                <a href="studentsgrp.php?one=dep&id=<?php echo $key['sub_id']; ?>"><button class="btn btn-info btn-xs"><i class=" fa fa-eye"></i></button>
                                </i></button></a>
